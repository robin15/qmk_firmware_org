...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------|--------+--------+--------+--------+--------+--------+--------|
      KC_ESC, KC_LGUI, KC_LALT,  EISU,          RAISE_SPC,           LOWER_SPC,   KC_RALT,     KC_LEFT, KC_DOWN, KC_RGHT  \
  //`-------------------------------------------------------------------------------------------------------------------'
  ...
  [_LOWER] = LAYOUT_base( \
  //,-------------------------------------------------------------------------------------------------------------+------.
        _____,  KC_F1,  KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,    KC_F7,   KC_F8,  KC_F9,   KC_F10,  KC_F11,  KC_DEL,  \
  //|--------+--------+--------+--------+--------+--------|--------+--------+--------+--------+--------+----------+------|
        _____, KC_INS, KC_SLCK,   _____,   KC_KANA,  _____,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_PGUP,      KC_ENT,      \
  //|--------+--------+--------+--------+--------+--------|--------+--------+--------+--------+--------+--------+--------|
        _____, KC_F11,  KC_F12,  KC_CAPS, KANJI,  KC_ENT,   KC_NLCK,   KC_GRV, KC_COMM, KC_DOT, KC_PGDN, KC_PGUP,  CT_AL_DE,\
  //|--------+--------+--------+--------+--------+--------|--------+--------+--------+--------+--------+--------+--------|
  ...
  //|--------+--------+--------+--------+--------+--------|--------+--------+--------+--------+--------+--------+--------|
        _____, XXXXX,   XXXXX,   XXXXX,   XXXXX,   XXXXX,   XXXXX,  KC_LBRC, KC_RBRC, KC_DOT,   KC_RO,  KC_PGUP, KC_BSLS, \
  //|--------+--------+--------+--------+--------+--------|--------+--------+--------+--------+--------+--------+--------|
        _____, _____,   KC_PSCR, MO(_LOWER),      _____,             _____,       _____,        KC_HOME, KC_PGDN, KC_END  \
  //`-------------------------------------------------------------------------------------------------------------------'
  // ExtraKey: Split backspace key or it is below the enter key.
  ),
//
  ...
  //|--------+--------+--------+--------+--------+--------|--------+--------+--------+--------+--------+--------+--------|
        _____, RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD,   XXXXX,   XXXXX,   XXXXX, KC_BTN1, KC_BTN2,   XXXXX, KC_MS_U, XXXXX,  \
  //|--------+--------+--------+--------+--------+--------|--------+--------+--------+--------+--------+--------+--------|
        _____,   _____,   _____,   _____,            XXXXX,            XXXXX,        _____,     KC_MS_L, KC_MS_D, KC_MS_R \
  //`-------------------------------------------------------------------------------------------------------------------'
  // ExtraKey: Split backspace key or it is below the enter key.
  )
};
...
static char layer_status_buf[35] = "komy keyboard start.\n";
