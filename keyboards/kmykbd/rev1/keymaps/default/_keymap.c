...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------|--------+--------+--------+--------+--------+--------+--------|
      KC_LSFT,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,   KC_N,    KC_M,  KC_COMM,  KC_DOT, KC_SLSH, KC_UP,   SFT_GRV, \
  //|--------+--------+--------+--------+--------+--------|--------+--------+--------+--------+--------+--------+--------|
  ...
  //|--------+--------+--------+--------+--------+--------|--------+--------+--------+--------+--------+--------+--------|
        _____, CT_F5,   CT_F4,   CT_F3,   CT_F2, CT_SFT_1,   XXXXX,  KC_LBRC, KC_RBRC, KC_DOT,   KC_RO,  KC_PGUP, KC_BSLS, \
  //|--------+--------+--------+--------+--------+--------|--------+--------+--------+--------+--------+--------+--------|
...
static inline void update_keymap_status(void) {
  ...
  snprintf(layer_status_buf, sizeof(layer_status_buf) - 1, "Layer: %s\nIME  : %s / %s\n",
          get_leyer_status(), (isxxx ? "Zen" : "Han"), kana_lock);
}
